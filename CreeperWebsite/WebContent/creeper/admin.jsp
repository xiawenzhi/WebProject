...
<ul class="layui-nav">
  	...
  	<li class="layui-nav-item" style="float:right;">
	    ...
	    <dl class="layui-nav-child">
	      <dd><a href="javascript:;" onclick="add()">推送文章</a></dd>
	      <dd><a href="javascript:;" onclick="location.href = '../creeper/login.jsp'">登出</a></dd>
	    </dl>
  	</li>
</ul>
<!-- 菜单栏管理 --><div style="background-image:url('../creeper/images/toolBarbg.png')">
...
<!-- 表单部分 --><!-- 推送文章 -->
<div id="newsform" style="position:fixed; width:800px; height:100%; z-index:2; top:0%; left:0px; right:0px; margin-left:auto; margin-right:auto;  background-color:#fff; box-shadow: 0 0 0 50vmax rgba(0,0,0,0.6);" hidden>
	<div style="width:100%; height:40px; background-color:#009f95; line-height:40px; font-size:20px; color:#fff;">&nbsp;添加文章<a href="javascript:$('#newsform').hide(); $('form')[0].reset();"><i class="layui-icon" style="font-size: 30px; float:right; margin-right:10px;" >&#x1006;</i></a></div>
	  	...
	  	<div class="layui-form-item">
	    		...
	    		<div class="layui-input-block">
	      		<select name="type" lay-verify="required">
	        		<option value="0" selected="selected">大学四年</option>
	        		<option value="1">身边事</option>
	        		<option value="2">征稿</option>
			        <option value="4">爱心爆棚</option>
	      		</select>
	    		</div>
	  	</div>
